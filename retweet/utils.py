...
RECAPTCHA_SECRET_FILE_NAME="recaptcha.secret"
GPT3_SECRET_ID="projects/16255416068/secrets/gpt3-secret/versions/1"
RECAPTCHA_SECRET_ID="projects/16255416068/secrets/retweet-recaptcha/versions/1"
...
def get_recaptcha_secret():
    ...
    recaptcha_secret = get_secret(RECAPTCHA_SECRET_FILE_NAME, RECAPTCHA_SECRET_ID)
    return recaptcha_secret
